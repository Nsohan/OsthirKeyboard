...
public final class KeyValue implements Comparable<KeyValue>
{
  ...
  public static KeyValue getSpecialKeyByName(String name)
  {
    switch (name)
    {
      ...
      case "switch_gif": return eventKey("GIF", Event.SWITCH_GIF, FLAG_SMALLER_FONT);
      ...
      case "switch_period_symbols": return eventKey("…", Event.SWITCH_PERIOD_SYMBOLS, FLAG_SMALLER_FONT);
