...
/** A guided, form-based editor for the single Tasker Automation JSON -
 ...
 - A fixed 3-row card for "nhck_replace" / "nhck_append" /
 "nhck_timeout" - always exactly these 3 fields, never added to or
 removed.
 - A dynamically-growing list of keyword -> Tasker task name rows
 (the "runtask1": "Task 1" style entries used with the nhck_replace/
 nhck_append triggers above).
 - A dynamically-growing list of "nhck_patterns" entries, each its
...
public class TaskerAutomationBuilderActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        android.view.View root = findViewById(R.id.tab_root);
        if (root != null)
        {
        ...
        android.view.View scrollView = findViewById(R.id.tab_scroll_view);
        if (scrollView != null)
        {
    ...
    private EditText make_pattern_name_input(String initial_value)
    {
        ...
        et.setTextColor(ContextCompat.getColor(this, R.color.settings_on_surface));
        et.setHintTextColor(ContextCompat.getColor(this, R.color.settings_on_surface_variant));
        et.setTextSize(14f);
    ...
    private TextView make_index_badge()
    {
        ...
        badge.setTextColor(ContextCompat.getColor(this, R.color.settings_on_primary));
    ...
    private ImageButton make_remove_button()
    {
        ...
        remove.setColorFilter(ContextCompat.getColor(this, R.color.settings_error));
    ...
    {
        final int normal_border_color = ContextCompat.getColor(this, R.color.settings_divider);
        final int focused_border_color = ContextCompat.getColor(this, R.color.settings_primary);
        final int normal_background_color = ContextCompat.getColor(this, R.color.settings_background);
        final int focused_background_color = ContextCompat.getColor(this, R.color.settings_background);

        edit_text.setTextColor(ContextCompat.getColor(this, R.color.settings_on_surface));
        edit_text.setHintTextColor(ContextCompat.getColor(this, R.color.settings_on_surface_variant));
        edit_text.setTextSize(13f);
        edit_text.setPadding(dp(12), dp(10), dp(12), dp(10));
        edit_text.setElevation(0);
        ...
        normal_bg.setCornerRadius(dp(10));
