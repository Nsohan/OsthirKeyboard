...
public class KeymapManager {
    ...
    public static com.nhs.customkeyboard.Keymap loadKeymap(
            Context context,
            String name) {
        ...
        try {
            ...
            return new com.nhs.customkeyboard.Keymap(stored.json);
    ...
    @Deprecated
    public static com.nhs.customkeyboard.Keymap loadActiveKeymap(Context context)
    {
