...
public class LayoutsPreference extends ListGroupPreference<LayoutsPreference.Layout>
{
  ...
  class LayoutsAddButton extends AddButton
  {
    ...
    public void onBindViewHolder(PreferenceViewHolder holder)
    {
      ...
      tint_button(holder, R.color.settings_primary);
    }
  }
  ...
  class AddKeymapButton extends Preference
  {
    ...
    {
      super.onBindViewHolder(holder);
      tint_button(holder, R.color.settings_secondary);
    }
  ...
  class AddKeymapBuilderButton extends Preference
  {
    ...
    {
      super.onBindViewHolder(holder);
      tint_button(holder, R.color.settings_tertiary);
    }
  ...
  static void tint_button(PreferenceViewHolder holder, int color_res)
  {
    int color = ContextCompat.getColor(holder.itemView.getContext(), color_res);
