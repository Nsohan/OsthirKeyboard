...
> java.util.concurrent.ExecutionException: com.android.builder.testing.api.DeviceException: com.android.ddmlib.InstallException: INSTALL_FAILED_UPDATE_INCOMPATIBLE: Existing package com.nhs.customkeyboard.debug signatures do not match newer version; ignoring!
```
...
```sh
adb uninstall com.nhs.customkeyboard.debug
./gradlew installDebug
```
